...
1. **R & NetLogo**
1. **Pera, Mas Já Não Tem?**
1. **Crise de Reprodutibilidade**
1. **logolink**
...
- [R](https://www.r-project.org/) é uma linguagem de programação **gratuita** e de **código aberto** desenvolvida para análise de dados e geração de gráficos [@ihaka1996].
- Foi criado a partir da linguagem **S**, por **R**oss Ihaka e **R**obert Gentleman, no departamento de estatística da [Universidade de Auckland](https://www.auckland.ac.nz/) (Nova Zelândia) em 1991 e apresentada à comunidade científica em **1993** [@peng2022].
- **Da academia, para a academia**.

- Criado por [Uri Wilensky](https://ccl.northwestern.edu/users/uri/) e [Seth Tisue](https://tisue.net/) em 1999, o [NetLogo](https://netlogo.org/) é uma plataforma de modelagem baseada em agentes, projetada para ser fácil de usar e acessível a uma ampla gama de usuários, incluindo aqueles sem experiência prévia em programação [@tisue2004].
- Desenvolvido tanto para fins educacionais quanto para pesquisa [@tisue2004].
...
- _Low Threshold, No Ceiling_`<br>`{=html}
[[@papert2020; @tisue2004a]]{style="font-size: 0.75em;"}
:::
...
## {data-menu-title="Temos um Problema" visibility="hidden"}

![](images/scriberia-reproducible-research.jpg){fig-align="center" style="width: 100%; padding-top: 0px;"}
...
::: {.notes}
- **Reprodutibilidade** versus **Replicabilidade** [@bezjak2018]
:::

## {data-menu-title="Temos um Problema" visibility="hidden" .nostretch}

![](images/fair-data-principles.png){fig-align="center" style="width: 80%; padding-top: 120px;"}

::: footer
[See @wilkinson2016 for more details]
:::

::: {.notes}
:::

## {data-menu-title="Temos um Problema"}
...
- Crise de reprodutibilidade [@baker2016; @peng2011].
- **Reprodutibilidade** versus **Replicabilidade** [@bezjak2018]
- Desenvolvimento de ferramentas abertas e especializadas, capazes de aumentar a transparência e promover a padronização e a reutilização de recursos entre pesquisadores [@berger2024; @ram2019].
- Ações semelhantes: Protocolo ODD [@grimm2006a; @grimm2020], AgentBlocks [@berger2024], [CoMSES Network](https://www.comses.net/) & Open Modeling Foundation ([OMS](https://www.openmodelingfoundation.org/)).
:::

## {data-menu-title="logolink" .smaller}
